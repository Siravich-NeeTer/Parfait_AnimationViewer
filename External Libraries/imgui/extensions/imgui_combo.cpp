...
namespace ImGui
{
    ...
    bool ComboAutoSelectData::SetNewValue(const char* new_val) noexcept
    {
        ...
        if (ret = CurrentSelection != InitialValues.Index) {
            strncpy_s(InputText, sizeof(InputText), new_val, StringCapacity);
    ...
    {
        strncpy_s(InputText, sizeof(InputText), InitialValues.Preview, StringCapacity);
    ...
    namespace Internal
    {
        ...
        {
            strncpy_s(buf, buf_capacity, new_str, buf_capacity);
